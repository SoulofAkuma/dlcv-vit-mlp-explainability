...
CONFIG_PATH = '/scratch/vihps/vihps01/vit-mlp-explainability/configs-mixed-neurons'
RESULTS_PATH = '/scratch/vihps/vihps01/vit-mlp-explainability/images-mixed-neurons'
